<template>
  <div>
    <div class="flex flex-wrap items-center w-full justify-between mt-6 mb-4">
      <h1 class="block text-4xl font-bold"><i class="far fa-sliders-v-square"></i> Open Graph Image Builder</h1>
      <div>
        <span class="text-right">
          <g-link
            class="text-blue-800 text-md hover:underline"
            to="/styleguide/"
          >Style Guide <i class="fab fa-css3"></i></g-link>
        </span> &nbsp;
        ...
        <span class="text-right"><a
            ...
            class="text-blue-800 text-md hover:underline"
            target="_blank"
          >Tailwind <i class="far fa-external-link-alt"></i></a></span> &nbsp;

        <span class="text-right"><a
            href="https://fontawesome.com/icons?d=gallery"
            class="text-blue-800 text-md hover:underline"
            target="_blank"
          >FA5 <i class="far fa-external-link-alt"></i></a></span> &nbsp;
        ...
        <span class="text-right"><a
          ...
          ><i class="far fa-download"></i></a></span>
      </div>
    </div>
